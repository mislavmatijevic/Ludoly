...
namespace Assets.Scripts.Utils
{
    internal static class GameResources
    {
        ...
        private static readonly List<string> _diceRollingStrs = new() {
        ...
        public static string STR_DiceRolling => _diceRollingStrs[GetRandomIndex(_diceRollingStrs.Count)];

        /// <summary>
        /// A string "{username}" is replaced by actual player's username.
        /// </summary>
        private static readonly Dictionary<int, List<string>> _diceResultStrs = new() {
        ...
        {
            List<string> responsesList = _diceResultStrs[value];
